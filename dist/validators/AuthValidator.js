        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!utils_1.isValidEmail(email)) errors.push('Invalid email');
                    if (!utils_1.isValidPassword(password)) errors.push('Password must contain 8 characters, uppercase and lowercase');
                    if (errors.length) return [2 /*return*/, { errors: errors }];
