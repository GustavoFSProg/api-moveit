...
function getUserByEmailAndPassword(email, password) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, User_1.default.findOne({ email: email, password: encryptPassword(password) }, USER_FIELDS)];
                case 1:
                    user = _a.sent();
...
function getUserByEmail(email) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    return [4 /*yield*/, User_1.default.findOne({ email: email }, USER_FIELDS)];
                case 1:
                    user = _a.sent();
                    return [2 /*return*/, user];
            }
